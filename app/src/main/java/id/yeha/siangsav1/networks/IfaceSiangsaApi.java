...
public interface IfaceSiangsaApi {
    ...
    void postRegis(String username, String email, String password, String nohp, String totalFamily, Response.Listener<JSONObject> successListener, Response.ErrorListener errorListener);
}
